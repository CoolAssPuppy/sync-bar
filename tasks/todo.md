...
- [ ] **5. UI wiring**
  - Add Notion as a Source (workspace + database + Category column picker)
  - Sync editor: Notion source -> Apple Notes destination; surface fresh/adopt/orphan counts before first run
